...
SESSION_ID: process.env.SESSION_ID === undefined ? 'Movie-MD&ntpkEKCa#3hBogCyrzbj2Hwiuh7Z8j-9zODAqglPBs5LHDhYo5RM' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
BUTTON: process.env.PORT === undefined ? "true" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '94750177369' : process.env.SUDO,
